    ...
    <div>
       ...
       <div v-else>
        ...
        <a href="#" class="text-blue-400" @click="$router.back()">
            ...
            <div class="relative">
                <router-link :to="'/contacts/' + contact.contact_id + '/edit'" class="px-4 py-2 rounded textsm text-green-500 border border-green-500 text-sm font-bold">Edit</router-link>
                <a href="#" class="px-4 py-2 rounded textsm text-red-500 border border-red-500 text-sm font-bold" @click="modal = ! modal">Delete</a>
                ...
                <div v-if="modal" class="bg-black opacity-25 absolute right-0 left-0 bottom-0 top-0 z-10" @click="modal = ! modal">
